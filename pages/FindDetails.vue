<template>
  <div class="list-detail">
    ...
    <div class="left-content">
      <p class="list-detail-t">
        {{ roundDetail.length && roundDetail[0].name }}
      </p>
    ...
    <div class="right-content">
      <div class="right-login">
        <div class="right-hi">
          <img src="images/user_moren.png" alt="" />
          <div class="right-font">
            <p>hi 您好</p>
            <p><a href="#">登录</a>发现更多精彩</p>
          </div>
        </div>
        <!-- 功能：点击“立即登录”跳转到登录页面 -->
        <div class="right-now">立即登录</div>
      </div>
      <div class="right-message">
        ...
        <div class="right-message-single">
          ...
          <div class="right-message-one">
            ...
            <p class="right-message-third">
              <span>房天下</span><span>2018.01.30</span>
            </p>
          </div>
        </div>
        ...
        <div class="right-message-single">
          ...
          <div class="right-message-one">
            ...
            <p class="right-message-third">
              <span>新浪网</span><span>2018.08.04</span>
            </p>
          </div>
        </div>
        ...
        <div class="right-message-single">
          ...
          <div class="right-message-one">
            ...
            <p class="right-message-third">
              <span>高质量生活知识</span><span>2018.08.06</span>
            </p>
          </div>
        </div>
        ...
        <div class="right-message-single">
          ...
          <div class="right-message-one">
            ...
            <p class="right-message-third">
              <span>买购网</span><span>2018.01.30</span>
            </p>
          </div>
        </div>
        ...
        <div class="right-message-single">
          ...
          <div class="right-message-one">
            ...
            <p class="right-message-third">
              <span>全球纺织网</span><span>2018.01.28</span>
            </p>
          </div>
        </div>
        ...
        <div class="right-message-single">
          ...
          <div class="right-message-one">
            <p class="right-message-two">窗帘有必要装纱帘吗？怎么选购窗帘？</p>
            <p class="right-message-third">
              <span>百度</span><span>2018.08.06</span>
            </p>
          </div>
        </div>
      </div>
